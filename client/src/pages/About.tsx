      ...
      <section className="py-20 premium-section">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Revolutionizing stamp collecting through blockchain technology and
            NFTs
          </p>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-lg text-muted-foreground leading-relaxed mb-6">
              ...
              traditional $5+ billion stamp collecting market with cutting-edge
              blockchain technology to create a secure, transparent, and
              accessible platform for collectors worldwide.
            </p>
            <p className="text-lg text-muted-foreground leading-relaxed">
              Our mission is to preserve cultural heritage while making stamp
              collecting more accessible to the next generation. By digitizing
              rare and valuable stamps as NFTs, we ensure their preservation for
              future generations while creating new opportunities for collectors
              and investors.
            </p>
          </div>
        </div>
            ...
            <Card className="border-border/50 bg-card/80 backdrop-blur-sm text-center">
              <CardContent className="p-8">
                ...
                <p className="text-muted-foreground text-sm">
                  Browse our curated catalog of thousands of authenticated
                  stamps from collections around the world.
                </p>
              </CardContent>
            </Card>
            <Card className="border-border/50 bg-card/80 backdrop-blur-sm text-center">
              <CardContent className="p-8">
                ...
                <p className="text-muted-foreground text-sm">
                  Buy securely with multiple payment options. Every transaction
                  is protected and instantly settled.
                </p>
              </CardContent>
            </Card>
            <Card className="border-border/50 bg-card/80 backdrop-blur-sm text-center">
              <CardContent className="p-8">
                ...
                <p className="text-muted-foreground text-sm">
                  Track your collection, monitor valuations, and manage your
                  portfolio from your personal dashboard.
                </p>
              </CardContent>
            </Card>
            <Card className="border-border/50 bg-card/80 backdrop-blur-sm text-center">
              <CardContent className="p-8">
                ...
                <p className="text-muted-foreground text-sm">
                  Share reviews, discuss rare finds, and connect with fellow
                  philatelists in a thriving global community.
                </p>
              </CardContent>
            </Card>
          </div>
