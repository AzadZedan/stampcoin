        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-muted-foreground mb-8">
              Join us in revolutionizing the $12+ billion stamp collecting
              market with blockchain technology
            </p>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="border-border/50 bg-card/80 backdrop-blur-sm">
              <CardContent className="p-8 text-center">
                ...
                <p className="text-muted-foreground">
                  The global stamp collecting market represents a massive
                  untapped opportunity for digital transformation
                </p>
              </CardContent>
            </Card>
            <Card className="border-border/50 bg-card/80 backdrop-blur-sm">
              <CardContent className="p-8 text-center">
                ...
                <div className="text-4xl font-serif font-bold text-secondary mb-2">
                  70M+
                </div>
                <div className="text-lg font-semibold mb-2">
                  Global Collectors
                ...
                <p className="text-muted-foreground">
                  A massive user base ready to embrace digital stamp collecting
                  and NFT technology
                </p>
              </CardContent>
            </Card>
            <Card className="border-border/50 bg-card/80 backdrop-blur-sm">
              <CardContent className="p-8 text-center">
                ...
                <p className="text-muted-foreground">
                  Global reach with collectors across all continents seeking
                ...
                <ul className="space-y-3 text-muted-foreground">
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      Commission on every stamp sale through the marketplace
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-primary mt-2"></div>
                    <div>
                      ...
                      Advanced features for serious collectors and dealers
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-primary mt-2"></div>
                    <div>
                      ...
                      Expert verification and grading services
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-primary mt-2"></div>
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            <Card className="border-border/50 bg-card/80 backdrop-blur-sm">
              <CardContent className="p-8">
                ...
                <p className="text-muted-foreground">
                  No specialized NFT platform exists for stamp collectors. We're
                  pioneering this niche market with deep domain expertise.
                </p>
              </CardContent>
            </Card>
            <Card className="border-border/50 bg-card/80 backdrop-blur-sm">
              <CardContent className="p-8">
                ...
                <p className="text-muted-foreground">
                  Partnership with leading philatelic experts ensures every
                  stamp is properly authenticated and valued.
                </p>
              </CardContent>
            </Card>
            <Card className="border-border/50 bg-card/80 backdrop-blur-sm">
              <CardContent className="p-8">
                ...
                <p className="text-muted-foreground">
                  Strategic partnerships with postal services, museums, and
                  collector associations worldwide.
                </p>
              </CardContent>
            </Card>
            <Card className="border-border/50 bg-card/80 backdrop-blur-sm">
              <CardContent className="p-8">
                ...
                <p className="text-muted-foreground">
                  Rare stamps have consistently appreciated in value, with some
                  increasing 300%+ over 10 years.
                </p>
              </CardContent>
            </Card>
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-xl mb-8 text-primary-foreground/90">
              Seeking strategic investment to scale operations, expand
              authentication partnerships, and accelerate user acquisition
            </p>
            <div className="grid md:grid-cols-3 gap-6 mb-8">
              <div>
