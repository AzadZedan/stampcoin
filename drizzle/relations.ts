...
export const usersRelations = relations(users, ({ many }) => ({
  ownedStamps: many(stamps, { relationName: "stampOwner" }),
  buyerTransactions: many(transactions, { relationName: "buyer" }),
  sellerTransactions: many(transactions, { relationName: "seller" }),
  favorites: many(favorites),
  reviews: many(reviews),
  partners: many(partners, { relationName: "partnerUser" }),
  approvedPartners: many(partners, { relationName: "approvedByUser" }),
}));
