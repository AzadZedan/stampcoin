...
const sampleCategories = [
  {
    name: "Vintage",
    description: "Classic stamps from the golden age of philately",
  },
  {
    name: "Modern",
    description: "Contemporary stamps with innovative designs",
  },
  {
    name: "Historical",
    description: "Stamps commemorating important historical events",
  },
...
const sampleStamps = [
  {
    ...
    description:
      "The world's first adhesive postage stamp, featuring Queen Victoria. A cornerstone of philatelic history.",
    price: 999.99,
    rarity: "legendary",
    year: 1840,
  ...
  },
  {
    ...
    description:
      "Famous US airmail stamp with inverted airplane print. One of the most valuable stamp errors.",
    price: 1499.99,
    rarity: "legendary",
    year: 1918,
  ...
  },
  {
    ...
    description:
      "Rare colonial stamp from Mauritius, highly sought after by collectors worldwide.",
    price: 899.99,
    rarity: "very_rare",
    year: 1847,
    country: "Mauritius",
  ...
  },
  {
    ...
    description:
      "Commemorative stamp series celebrating the Munich Olympics with iconic design.",
    price: 149.99,
    rarity: "rare",
    year: 1972,
    country: "Germany",
  ...
  },
  {
    ...
    description:
      "Historic stamp commemorating humanity's first steps on the moon in 1969.",
    price: 299.99,
    rarity: "rare",
    year: 1969,
    country: "United States",
  ...
  },
  {
    ...
    description:
      "Beautiful stamp featuring Leonardo da Vinci's masterpiece, the Mona Lisa.",
    price: 79.99,
    rarity: "uncommon",
    year: 2010,
    country: "France",
  ...
  },
  {
    ...
    description:
      "Modern stamp supporting wildlife conservation, featuring the beloved giant panda.",
    price: 49.99,
    rarity: "uncommon",
    year: 2020,
    country: "China",
  ...
  },
  {
    ...
    description:
      "Elegant Japanese stamp celebrating the beauty of cherry blossoms in spring.",
    price: 39.99,
    rarity: "common",
    year: 2021,
    country: "Japan",
  ...
  },
  {
    ...
    description:
      "Commemorative stamp marking 100 years of the iconic Eiffel Tower.",
    price: 89.99,
    rarity: "uncommon",
    year: 1989,
    country: "France",
  ...
  },
  {
    ...
    description:
      "Stunning stamp showcasing India's architectural marvel, the Taj Mahal.",
    price: 59.99,
    rarity: "common",
    year: 2015,
    country: "India",
  ...
  },
  {
    ...
    description:
      "Art stamp featuring Vincent van Gogh's famous painting, Starry Night.",
    price: 69.99,
    rarity: "uncommon",
    year: 2018,
    country: "Netherlands",
  ...
  },
  {
    ...
    description:
      "Official stamp commemorating the 2018 FIFA World Cup in Russia.",
    price: 45.99,
    rarity: "common",
    year: 2018,
    country: "Russia",
  ...
  },
  {
    ...
    description:
      "Majestic stamp depicting one of the Seven Wonders of the World.",
    price: 55.99,
    rarity: "common",
    year: 2016,
    country: "China",
  ...
  },
  {
    ...
    description:
      "Beautiful nature stamp featuring rare butterfly species from around the world.",
    price: 34.99,
    rarity: "common",
    year: 2022,
    country: "Brazil",
  ...
  },
  {
    ...
    description:
      "Modern stamp celebrating humanity's journey to explore the Red Planet.",
    price: 99.99,
    rarity: "rare",
    year: 2021,
    country: "United States",
